...
// ################ Class tftDisplay Method definitions ################  
void tftDisplay::setScreenWidth(void)
{
  //m_screenWidth=xpos;
   m_screenWidth=tft.width();
}
void tftDisplay::setScreenDepth(void)
{
  //m_screenDepth=ypos;
  m_screenDepth=tft.height();
}
unsigned int tftDisplay::getScreenWidth(unsigned int m_screenWidth)
{
